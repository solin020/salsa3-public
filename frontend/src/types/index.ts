import type { SubmissionQuality, StimulusType } from "./schedule"
export type Audio = {
    type: 'audio'
    id: string
    uri: string
...
export type TestPrototype = {
    ...
    groups: string[]
    randomized: boolean
    schedule_type:'phone'|'app'
}
export type TestPrototypeMeta = {
    id: string
    groups: string[]
    response_stimuli: {id:string, type:StimulusType}[]
    randomized: boolean,
    stimulus_ids: string[]
    schedule_type:'phone'|'app'
}
...
export type TwilioInfo = {
    ...
    require_caller_login:boolean
    lookup_participant_script:boolean
}
